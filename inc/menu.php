    ...
    <div class="dci-language-selector">
      <?php
          foreach ($available_languages as $language) {
                  ?>
        <a href="?<?php echo $query_variables; ?>&set_language=<?php echo $language; ?>" <?php echo $language == $current_language ? 'class="selected"' : ''; ?>>
          <?php echo $language_labels[$language] ?? $language; ?>
        </a>
        <?php
            }
                ?>
      ...
      <button class="btn btn-bulky" role="menuitem" aria-haspopup="true">
        <span class="glyph" aria-label="Notifications" role="img">
          <span class="icon icon-mail" aria-hidden="true"></span>
            ...
            {
                if (empty((string) $_GET['set_language'])) {
                    return false;
                }
            ...
            public static function getCoursesOfUser(
                ...
                $from_cache = dciSkin_cache::get('dciSkin_menu::getCoursesOfUser');
                ...
                foreach ($items as $obj_id) {
                    ...
                    if (! ilObjCourseAccess::_isActivated($obj_id, $visible, false)) {
                        continue;
                    }
                ...
                dciSkin_cache::add('dciSkin_menu::getCoursesOfUser', $references);
